...
<security:authorize access="hasRole('ADMIN')" >
	...
	<table style="width:100%">
  		...
  		<tr>
    		...
    		<td><jstl:out value="${minMaxAvgStddevFixUpTasksPerUser}" /></td> 
  		</tr>
  		...
  		<%--<tr>
    		...
    		<td><jstl:out value="${histogram?}" /></td> 
  		</tr>--%>
  		
  		<tr>
    		<td><jstl:out value="${queryb1}" /></td>
    		<td><jstl:out value="${ratioCountMinMaxAvgAndStddevOfBrotherhoodsByArea}" /></td> 
  		</tr>
  		<tr>
