...
public class MessageService {
	...
	public void paradePublished(final Parade p) {
		...
		final Message msg = this.create();
		msg.setSubject("A parade has been published / Se ha publicado una desfile.");
		msg.setBody("A parade has been published / Se ha publicado una desfile.");
		msg.setPriority("HIGH");
		msg.setTags("Parade published / Desfile publicada");
		msg.setSent(new Date(System.currentTimeMillis() - 1));
