...
When exporting the personal data, we opted to only provide the values of the attributes of the actors themselves but "spammer" and "score" since having access to that information may have bad consecuences. We decided not to show the real values of user account and the collections attatched to them as they are not personal info as the rest of attributes are. This was also discussed in theory class so we decided to do it.
